...
<div class="wrapper">
	<!-- 글 검색 결과 -->
	<div class="blank" style="height:100px;"><h1><i class="fas fa-search"></i>검색 결과</h1></div>
	...
	<table class="listt">
		...
		<tr>
			...
			<td id="titleline" class='<%=vo.getId()%>'
				onclick="displayReadForm('<%=vo.getId()%>')"><span id="head">[<%=vo.getHeader()%>]
			</span><%=vo.getTitle()%></td>
			<td class='<%=vo.getId()%>'><%=vo.getNickname()%></td>
...
<!-- 	<div align="right">
		<button id="writenews" onclick="displayWriteForm();">글쓰기</button>
	</div> -->
